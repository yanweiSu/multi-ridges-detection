...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    //                             mu1 * pow(multi1*tic[fund[i-1]] - tic[k1+fundM[i-1]-bw1], 2) + \
    //                             mu2 * pow(multi2*tic[fund[i-1]] - tic[k2+fundM[NRow+i-1]-bw2], 2) + \
    //                             mu3 * pow(multi3*tic[fund[i-1]] - tic[k3+fundM[2*NRow+i-1]-bw3], 2);
    //                             if(tmp < minval)
    //                                 minval = tmp;
    //                         }
    //                     }
    ...
    //                 mu1 * pow(multi1*tic[fund[i]] - tic[j1+fundM[i]-bw1], 2) + \
    //                 mu2 * pow(multi2*tic[fund[i]] - tic[j2+fundM[NRow+i]-bw2], 2) + \
    //                 mu3 * pow(multi3*tic[fund[i]] - tic[j3+fundM[2*NRow+i]-bw3], 2);
    //                 tmp = fabs(val-tmp);
    //                 if(tmp < eps) {
